...
//public class Proba3 {
// Command interface
 interface CommandAdd{
    void execute();
}
// the Invoker class
 class InvokerAdd {
    private CommandAdd addVertex;
    
    public InvokerAdd (CommandAdd addVert) {
...
//Command for add vertex
 class AddVertexCommand implements CommandAdd{
    private ReceiverAdd thetest;
    
    public AddVertexCommand (ReceiverAdd test){
        this.thetest = test;
    }
    public void execute() {
        thetest.print();
...
public class TestCommand{
    public static void main(String[] args){
        ReceiverAdd RA = new ReceiverAdd();
        CommandAdd CA = new AddVertexCommand(RA);
        
        InvokerAdd IA = new InvokerAdd(CA);
